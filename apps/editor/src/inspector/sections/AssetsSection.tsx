...
export function AssetsSection({ context }: InspectorSectionProps) {
  ...
  return (
    <>
      <div className="inspector-section">
        <div className="inspector-section-header">Upload</div>
      ...
      {assetList.length > 0 && (
        <div className="inspector-section">
          <div className="inspector-section-header">Library ({assetList.length})</div>
          <div className="inspector-section-content">
